...
export const SmallCard = ({ bgCard, icon, total, thisMonth, heading }) => {
  ...
  return (
    <Card
      className={`min-w-[290px] 2xl:min-w-[280px] xl:min-w-[200px] w-[23%] card h-auto min-h-[150px] rounded-lg px-3 py-5 flex flex-col justify-between hover:shadow-xl hover:shadow-slate-300 `}
