  ...
  return (
    <div className="w-[320px] bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg min-h-full md:flex md:flex-col hidden fixed transition-all duration-300 ease-in-out">
      <div className="p-6 border-b border-gray-100 dark:border-gray-700">
        <h1 className="text-lg font-semibold text-gray-800 dark:text-blue-600">
          Menu
        </h1>
      </div>
      ...
      <Link
        to="/"
        className="flex items-center gap-3 py-3 px-6 text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/20 border-l-4 border-l-blue-600 dark:border-l-blue-400 transition-colors duration-200"
      >
